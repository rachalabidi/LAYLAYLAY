    ...
    <div id="container">
        ...
        <div id="sidemenu">
            <ul id="menu">
                ...
                <li id="pages-button">
                 <a href="http://localhost:8676/miniProjetDaw/modProile">
                    ...
                    <span class="title">modifié profil</span></a>
                </li>
                <li id="templates-button">
                                <a href="http://localhost:8676/miniProjetDaw/studentListServletForTeacher">

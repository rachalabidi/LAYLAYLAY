...
@WebServlet("/modProile")

public class modProile  extends HttpServlet{
	private static final long serialVersionUID = 1L;
	 ...
	 protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			if (request.getSession().getAttribute("user") != null) {
				RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/profileUpdate.jsp");
				dispatcher.include(request, response);
			}/*else if(request.getSession().getAttribute("") != null) {
...
protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	...
	out.print("<center><h2> ur infos are  updated successfully <h2>");
	System.out.println("<center><h2> ur infos are  updated successfully <h2>");

...
public ArrayList<Ètudiant> getEtudiantGroupedBYgroup(String groupe) throws InstantiationException, IllegalAccessException {
			String requete;
			PreparedStatement statement;
			...
			try {
				...
				connectDB();
				requete = "SELECT * FROM Ètudiant WHERE groupe = ? ";
							statement = connection.prepareStatement(requete);
				...
				System.out.println("yessss arraylist student by grp!");
			} catch (SQLException e) {
				System.out.println(e);
			}
